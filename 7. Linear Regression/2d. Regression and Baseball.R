...
# do the similar analysis on all players that played the 2013 and 2014 seasons and 
...
# use dslabs function rfalling_object to generate simulations of dropping balls
library(dslabs)
